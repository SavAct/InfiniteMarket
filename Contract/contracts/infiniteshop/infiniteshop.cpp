...
inline void infiniteshop::removeItemFromUserTable(const name &user, const uint64_t id, const uint64_t &category)
{
...
inline void infiniteshop::removeItemFromUserTable(users_table &users_Table, const users_table::const_iterator &user_itr, const uint64_t id, const uint64_t &category)
{
